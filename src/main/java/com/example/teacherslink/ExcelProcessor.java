    ...
    public static void processExcelFile(String filePath) throws IOException {
        ...
        for (int rowIndex = 0; rowIndex <= sheet.getLastRowNum(); rowIndex++) {
            ...
            if (idCell != null && isValidId(idCell.getStringCellValue())) {
                ...
                instructor.setOnline(currentRow.getCell(4).getStringCellValue());

                //changing 11/09/23
                instructor.setCampus(currentRow.getCell(5).getStringCellValue());

                instructor.setSecond_course(currentRow.getCell(6).getStringCellValue());
                instructor.setThird_course(sheet.getRow(rowIndex + 1).getCell(6).getStringCellValue());
